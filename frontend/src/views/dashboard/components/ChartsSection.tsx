...
const ChartsSection = (props: ChartsSectionProps) => {
  const { trendData, categoryData } = props;
  return (
      ...
      <div className="lg:w-[70%] bg-white p-8 rounded-2xl shadow-sm border border-slate-50">
        <div className="flex justify-between items-end mb-8">
          ...
          <div className="flex gap-2 p-1 bg-slate-50 rounded-xl">
            <button className="px-4 py-2 rounded-lg text-xs font-bold text-slate-500 hover:text-slate-900 transition-all">
              WEEK
            </button>
            <button className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-xs font-bold shadow-lg shadow-indigo-200 transition-all">
              MONTH
            </button>
          </div>
        </div>
